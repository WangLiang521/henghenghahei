...
-(void) updateDots
{
    ...
    {
        activeImage = [UIImage imageNamed:@"barrier_icon_selected"];     //设置当前圆点图片
        inactiveImage = [UIImage imageNamed:@"barrier_icon_normal"];   //设置其他圆点图片
        ...
        UIImageView *linshi=[[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 6, 6)]; //初始化圆点图片大小
