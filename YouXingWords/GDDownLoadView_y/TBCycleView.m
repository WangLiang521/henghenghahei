...
{
    if (_label == nil) {
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/2.0, self.frame.size.height/2.0)];
...
//    CGPoint center = CGPointMake(100, 100);
    ...
    CGFloat lineWidth = TBLineWidth;
    CGFloat radius = (self.frame.size.width- lineWidth)/2.0 ;
    ...
    _progressLayer.strokeColor = [TBStrokeColor CGColor]; //指定path的渲染颜色,这里可以设置任意不透明颜色
